...
namespace LXF_Framework
{
    namespace LXF_UISystem
    {
            ...
            public static void InitStretchAnchor(this RectTransform rect, string pos)
            {
                switch (pos)
                {
                    case "left":
                        ...
                        break;
                    case "centerY":
                        rect.SetAnchor(new Vector2(0.5f, 0), new Vector2(0.5f, 1));
                        break;
                    case "right":
        ...
        public static class LXF_Image
        {
            ...
            public static void SetColor(this Image i, bool isTransparent = false) =>
                i.color = isTransparent ? new Color(1, 1, 1, 0) : new Color(1, 1, 1, 1);
